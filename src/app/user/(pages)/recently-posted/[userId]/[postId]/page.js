...
const ContactPetDetails = () => {
  ...
  useEffect(() => {
    const imgagesArr = [
      "/images/Nextpet-imgs/all-icons/user.svg",
                    ...
                    <div className="breedeerdasboard-createpost-inner">
                        ...
                        <div className="breedeerdasboard-createpost-right">
                            <div className="postcreate-heading">
                                ...
                                <div className="inner-heartt">
                                    <a href="#" style={{padding: '7px 4px'}}><Image src="/images/Nextpet-imgs/dashboard-imgs/share.svg"
                                        alt="" width={37} height={31}/></a>
                                </div>
                                </div>
                            </div>
                        <form>
                            ...
                            <div className="list-post-form">
                                ...
                                <div className="posts-btn-wrap">
                                    <button type="button" value="Submit" data-bs-target="#breeder-guide2"
                                    data-bs-toggle="modal">Contact
                                    Breeder</button>
                                </div>
